#
#  Be sure to run `pod spec lint AWHReportModule.podspec' to ensure this is a
#  确保运行“pod spec lint AWHReportModule.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHReportModule"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHReportModule.git", :tag => "#{s.version}" }
...
#  s.source_files  = "AWHReportModule/**/*.{h,m,swift}"
#  # s.exclude_files = "Classes/Exclude"   #排除文件
#
#  s.public_header_files = "AWHReportModule/**/*.h"
  ...
  # s.resource  = "icon.png"
    s.resources = ['AWHReportModule.framework/AWHRMZFPlayer.bundle']
